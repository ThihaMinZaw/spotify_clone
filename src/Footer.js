    ...
    return (
        <div className="footer">
           <div className="footer_left">
               ...
               {item ? (<div className="footer_songInfo" ><h4>{item.name}</h4><p>{
               item.artists.map((artist)=>artist.name).join(", ")}</p></div>):(<div className="footer_songInfo"><h4>No song is playing</h4><p>...</p></div>)} 
           </div>
           ...
           <div className="footer_center">
               ...
               {
                   playing?(<PauseCircleOutlineIcon onClick={handlePlayPause} fontSize="large" className="footer_icon" />):(
               ...
               <RepeatIcon className="footer_right" />
